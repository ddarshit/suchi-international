...
import { Button, Collapse, Grid, TableHead } from "@mui/material";
...
const rows = [
  createData("Milk Pot", 305, 3.7, 67, 4.3, 67, 4.3),
  createData("Dhakkan", 452, 25.0, 51, 4.9, 67, 4.3),
...
export default function InventoryMaster() {
  ...
  return (
<>
    {openInventory && <AddInventory onClose={()=>setOpenInventory(false)}/>}
    <Box sx={{ mb: 2,mt:3 }} elevation={5} component={Paper}>
      <Paper sx={{ width: "100%", pt: 2 }} elevation={0}>
        <Grid container spacing={0} justifyContent="space-between" sx={{paddingInline:"14px",mb:3}}>
        <Typography variant="h6" fontWeight={600}>Inventory</Typography>
        <Button variant="contained" onClick={()=>setOpenInventory(true)}>Add Data</Button>
        </Grid>
        <TableContainer>
          <Table
            size="small"
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        <TableCell >{row.ownCompany}</TableCell>
